 ...
 */
public class MasqTurnPIDController {
    ...
    public MasqTurnPIDController(double kp, double ki, double kd) {
        this.kp = kp;
        this.ki = ki;
        this.kd = kd;
    }
    public MasqTurnPIDController(double kp, double ki) {
        this.kp = kp;
        this.ki = ki;
    }
    public MasqTurnPIDController(double kp) {
        this.kp = kp;
    }
    public MasqTurnPIDController(MasqPIDConstants constants) {
        kp = constants.kp;
        ki = constants.ki;
        kd = constants.kd;
    }
