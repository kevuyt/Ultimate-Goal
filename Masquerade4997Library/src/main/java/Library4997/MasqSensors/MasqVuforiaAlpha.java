...
public class MasqVuforiaAlpha implements MasqHardware, MasqSensor {
    ...
    public MasqVuforiaAlpha(String target1, String target2, String target3, String asset){
    ...
    public MasqVuforiaAlpha(String target1, String target2, String asset){
        this.target1 = target1;
        this.target2 = target2;
        this.asset = asset;
    ...
    public MasqVuforiaAlpha(String target1, String asset){
        this.target1 = target1;
        this.asset = asset;
