package com.disnodeteam.masqcv.filters;
...
public class MasqColorFilter extends MasqCVColorFilter {
    ...
    public MasqColorFilter(ColorPreset filterColor){
        color = filterColor;
    }

    public MasqColorFilter(ColorPreset filterColor, double filterThreshold){
        color = filterColor;
