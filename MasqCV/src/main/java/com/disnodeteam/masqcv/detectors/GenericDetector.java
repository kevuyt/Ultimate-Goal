...
import com.disnodeteam.masqcv.filters.HSVColorFilter;
...
public class GenericDetector extends OpenCVPipeline {
    ...
    public MasqCVColorFilter colorFilter = new HSVColorFilter(new Scalar(50,50,50), new Scalar(50,50,50));
    ...
    public Mat processFrame(Mat rgba, Mat gray) {
        ...
        preConvert.release();
        Imgproc.putText(workingMat, "MasqCV v1.1 Generic: " + newSize.toString() + " - " + speed.toString() + " - " + detectionMode.toString(), new Point(5, 30), 0, 1.2, new Scalar(0, 255, 255), 2);
