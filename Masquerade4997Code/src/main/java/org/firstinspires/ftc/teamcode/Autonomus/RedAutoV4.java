...
public class RedAutoV4 extends MasqLinearOpMode implements Constants {
    ...
    public void runVuMark(String vuMark) {
        ...
        else if (MasqExternal.VuMark.isRight(vuMark)) robot.drive(250, POWER_OPTIMAL, Direction.BACKWARD);
        else if (MasqExternal.VuMark.isUnKnown(vuMark)) robot.drive(165, POWER_OPTIMAL, Direction.BACKWARD);
