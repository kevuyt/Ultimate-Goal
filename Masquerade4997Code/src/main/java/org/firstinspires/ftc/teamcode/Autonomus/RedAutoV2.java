...
public class RedAutoV2 extends MasqLinearOpMode implements Constants {
    ...
    public void runVuMark(String vuMark) {
        ...
        if (MasqUtils.VuMark.isCenter(vuMark)) robot.drive(27, POWER_OPTIMAL, Direction.BACKWARD, 3);
        else if (MasqUtils.VuMark.isLeft(vuMark)) robot.drive(26, POWER_OPTIMAL, Direction.BACKWARD, 2);
        else if (MasqUtils.VuMark.isRight(vuMark)) {robot.drive(20, POWER_OPTIMAL, Direction.BACKWARD, 2);}
        else if (MasqUtils.VuMark.isUnKnown(vuMark)) robot.drive(27, POWER_OPTIMAL, Direction.BACKWARD, 3);
