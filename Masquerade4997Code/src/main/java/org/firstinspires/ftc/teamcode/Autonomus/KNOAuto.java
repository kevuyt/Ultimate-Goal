 ...
 * Project: MasqLib
 */
@Autonomous(name = "KNO3", group = "Tank")
public class KNOAuto extends MasqLinearOpMode implements Constants {
    ...
    public void runLinearOpMode() throws InterruptedException {
        ...
        if (dHeading < rightBound) {
            ...
            falcon.drive(90, Direction.BACKWARD, 3);
        }
        else if (dHeading >= rightBound && dHeading < centerBound) {
            falcon.turnAbsolute(94, Direction.LEFT);
            dash.create("Center");
            dash.update();
            ...
            falcon.collector.setPower(-.5);
            sleep(2);
            falcon.turnAbsolute(-145, Direction.LEFT, 3);
