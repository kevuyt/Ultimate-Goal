package org.firstinspires.ftc.teamcode.MarkOne.Autonomous.Legacy;
...
public class BlueThreeNeut extends MasqLinearOpMode {
    ...
    public void runLinearOpMode() {
        ...
        if (position == CVInterpreter.SkystonePosition.LEFT) runSimultaneously(
                () -> mainAuto(stones.get(1), stones.get(4),stones.get(3)),
                () -> robot.camera.stop()
        );
        else if (position == CVInterpreter.SkystonePosition.MIDDLE) runSimultaneously(
