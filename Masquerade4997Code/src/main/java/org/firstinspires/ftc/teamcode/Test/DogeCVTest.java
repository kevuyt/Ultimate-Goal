...
public class DogeCVTest extends MasqLinearOpMode implements Constants {
    ...
    public void runLinearOpMode() throws InterruptedException {
        ...
        // Optional Tuning
        falcon.goldAlignDetector.alignSize = 5; // How wide (in pixels) is the range in which the gold object will be aligned. (Represented by green bars in the preview)
        ...
        waitForStart();
        while (opModeIsActive()) {
            dash.create("A: ", falcon.goldAlignDetector.getAligned());
            dash.create("X:", falcon.goldAlignDetector.getXPosition());
            dash.create("IS SEEN: ", falcon.goldAlignDetector.isFound());
            dash.update();
        }
