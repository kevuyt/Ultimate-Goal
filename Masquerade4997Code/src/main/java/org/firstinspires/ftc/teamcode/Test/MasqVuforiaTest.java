...
import Library4997.MasqSensors.MasqVuforia.TargetFacing;
...
public class MasqVuforiaTest extends MasqLinearOpMode {
    ...
    public void runLinearOpMode() throws InterruptedException {
        ...
        robot.vuforia.setOrientationOne(TargetFacing.RIGHT);
        robot.vuforia.setPositionTwo(0,500,0);
        robot.vuforia.setOrientationTwo(TargetFacing.RIGHT);
        robot.vuforia.setPositionThree(0,500,0);
        robot.vuforia.setOrientationThree(TargetFacing.RIGHT);
        robot.vuforia.init();
