...
/**
 * Deprecated. See vuforia_initializeExtended.
 */
...
Blockly.JavaScript['vuforia_initialize'] = function(block) {
  ...
  var dx = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_DX', Blockly.JavaScript.ORDER_NONE);
  var dy = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_DY', Blockly.JavaScript.ORDER_NONE);
  var dz = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_DZ', Blockly.JavaScript.ORDER_NONE);
  var xAngle = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_X_ANGLE', Blockly.JavaScript.ORDER_NONE);
  var yAngle = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_Y_ANGLE', Blockly.JavaScript.ORDER_NONE);
  var zAngle = Blockly.JavaScript.valueToCode(
      block, 'PHONE_LOCATION_ON_ROBOT_Z_ANGLE', Blockly.JavaScript.ORDER_NONE);
...
Blockly.JavaScript['vuforia_initializeExtended'] = function(block) {
  ...
  var useCompetitionFieldTargetLocations = Blockly.JavaScript.valueToCode(
      block, 'USE_COMPETITION_FIELD_TARGET_LOCATIONS', Blockly.JavaScript.ORDER_NONE);
...
Blockly.Blocks['vuforia_typedEnum_trackableName'] = {
  init: function() {
    ...
    var thisBlock = this;
    var TOOLTIPS = [
        ['DEGREES', 'The TrackableName value DEGREES.'],
        ['RADIANS', 'The TrackableName value RADIANS.'],
    ];
