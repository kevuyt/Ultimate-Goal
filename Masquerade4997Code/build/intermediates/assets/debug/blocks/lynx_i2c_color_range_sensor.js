...
Blockly.Blocks['lynxI2cColorRangeSensor_setProperty_Number'] = {
  init: function() {
    ...
    var thisBlock = this;
    var TOOLTIPS = [
        ['I2cAddress7Bit', 'The 7 bit I2C address of the Lynx color range sensor.'],
        ['I2cAddress8Bit', 'The 8 bit I2C address of the Lynx color range sensor.'],
    ];
...
Blockly.Blocks['lynxI2cColorRangeSensor_getProperty_Number'] = {
  init: function() {
    ...
    var thisBlock = this;
    var TOOLTIPS = [
        ['Alpha', 'The amount of light detected by the Lynx color range sensor.'],
        ['Argb', 'The color detected by the Lynx color range sensor, as an ARGB value.'],
        ['Blue', 'The blue value detected by the Lynx color range sensor.'],
        ['Green', 'The green value detected by the Lynx color range sensor.'],
        ['I2cAddress7Bit', 'The 7 bit I2C address of the Lynx color range sensor.'],
        ['I2cAddress8Bit', 'The 8 bit I2C address of the Lynx color range sensor.'],
        ['LightDetected', 'Gets the amount of light detected by the Lynx color range sensor. ' +
        ...
        ['RawLightDetectedMax', 'Returns the maximum value that can be returned for ' +
            'RawLightDetected'],
        ['Red', 'The red value detected by the Lynx color range sensor.'],
    ];
    this.setTooltip(function() {
      var key = thisBlock.getFieldValue('PROP');
      for (var i = 0; i < TOOLTIPS.length; i++) {
