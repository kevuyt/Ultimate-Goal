...
/**
 * This class is intended to provide a convenient way to load org.firstinspires.ftc.teamcode.OpenCV's native
...
public class OpenCVNativeLoader implements OpenCVInterface {
    ...
    public void init() {
        ...
        Logger.getLogger("org.opencv.osgi").log(Level.INFO, "Successfully loaded org.firstinspires.ftc.teamcode.OpenCV native library.");
    }
}
